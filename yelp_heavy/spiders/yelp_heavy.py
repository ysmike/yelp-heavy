...
class PleySpider(CrawlSpider):
    ...
    vertical_crawl = "//p[@class='lemon--p__373c0__3Qnnj text__373c0__2Kxyz text-color--black-regular__373c0__2vGEn text-align--left__373c0__2XGa- text-weight--bold__373c0__1elNz text-size--inherit__373c0__2fB3p']/a"
    horizontal_crawl = "//span[@class='lemon--span__373c0__3997G text__373c0__2Kxyz text-color--black-extra-light__373c0__2OyzO text-align--left__373c0__2XGa- text-size--large__373c0__3t60B']//a[@class='lemon--a__373c0__IEZFH link__373c0__1G70M link-color--inherit__373c0__3dzpk link-size--inherit__373c0__1VFlE']"
    ...
    def parse_content(self, response):
        ...
        num_of_reviews = int(json.get("aggregateRating").get("reviewCount"))
        rating = float(json.get("aggregateRating").get("ratingValue"))
