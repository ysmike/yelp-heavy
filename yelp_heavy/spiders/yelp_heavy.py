...
class PleySpider(CrawlSpider):
    ...
    start_urls = [
        ...
        "https://www.yelp.com/search?find_desc=restaurants&find_loc=Theater%20District%2C%20Manhattan%2C%20NY&l=g%3A-73.97987510892449%2C40.76133781027203%2C-73.98626949521599%2C40.75646178872317"
    ]
    ...
    def parse_content(self, response):
        ...
        postalcode = int(json["address"]["postalCode"])
        ...
        raw_histogram = response.xpath("//td[@class='histogram_count']/text()").getall()
